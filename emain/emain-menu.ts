...
function makeFileMenu(
    ...
    if (isDev || featureWaveAppBuilder) {
        fileMenu.splice(1, 0, {
            label: "Новое окно WaveApp Builder",
